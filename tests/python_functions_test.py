...
#       self.assertEqual( 10, return_10_result )
  ...
  def test_add_string_as_number__2(self):
    add_result = add_string_as_number( "3", "4" )
    self.assertEqual( 7, add_result )
  ...
  def test_volume_of_cube(self):
    test_cube = volume_of_cube(5, 5, 5)
    self.assertEqual(125, test_cube)


  #Given a String, return the String reversed
  def test_reverse_string(self):
    test_reverse = reverse_string("CodeClan")
    self.assertEqual("nalCedoC", test_reverse)
  ...
  def test_fahrenheit_to_celsius(self):
    f_to_c = fahrenheit_to_celsius(68)
    self.assertEqual(22.4, f_to_c)
